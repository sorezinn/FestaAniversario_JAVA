package exercicio_classe_festa_aniversario;

public class AtributosFestaAniversario {
	    ...
	    public AtributosFestaAniversario(String nomeAniversariante, int idadeAniversariante, String local, String data , int numeroConvidados) {
	    ...
	    public void status() {
	        ...
	        System.out.println("Idade do Aniversariante: " + getIdadeAniversariante());
